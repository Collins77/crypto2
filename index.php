    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="#" class="navbar-link" data-nav-link>Investment Plans</a>
          </li>
          ...
          <li class="navbar-item">
            <a href="#" class="navbar-link" data-nav-link>Coins</a>
          </li>
      ...
      if(!isset($_SESSION['logged_in'])){
        echo '<a href="auth/login.php" class="btn btn-outline" id="loginButton">Login</a>';
        echo '<a href="auth/login.php" class="btn btn-outline" id="loginButton">SignUp</a>';
      }else{
        echo '<h2>Avatar</h2>';
      }
      ?>
